...
; For the simplicity we set the same alignment both
; for memory and file.
...
DataDirectories:
    ...
    .ImportTable           dd ImportDescriptor, 0 ; 120 8
...
HeaderPE_Sections_code:
    ...
    .VirtualSize          dd 512                ; 8  4 TODO
    .VirtualAddress       dd code_section_begin ; 12 4
    .SizeOfRawData        dd 512                ; 16 4 TODO
    ...
    .Characteristics      dd 0x60000020         ; 36 4 TODO

HeaderPE_Sections_data:
    .Name                 db '.data', 0, 0, 0   ; 0  8
    .VirtualSize          dd 512                ; 8  4 TODO
    .VirtualAddress       dd data_section_begin ; 12 4
    .SizeOfRawData        dd 512                ; 16 4 TODO
    ...
    .NumberOfRelocations  dw 0                  ; 32 2 (obsolete)
    .NumberOfLineNumbers  dw 0                  ; 34 2 (obsolete)
    .Characteristics      dd 0xc0000040         ; 36 4 TODO
