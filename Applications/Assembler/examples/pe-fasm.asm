...
HeaderPE_Optional:
    ...
    .SizeOfImage         dd file_end      ; 56 4 Size of image in memory, including headers,
...
HeaderPE_End:
  db 1*SECTION_ALIGNMENT - HeaderPE_End dup 0
...
code_section_end:
  db 2*SECTION_ALIGNMENT - code_section_end dup 0
...
data_section_end:
  db 3*SECTION_ALIGNMENT - data_section_end dup 0
