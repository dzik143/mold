...
EXCEPTION_PDATA_CONTINUE_EXECUTION EQU 0
EXCEPTION_PDATA_CONTINUE_SEARCH    EQU 1
EXCEPTION_PDATA_NESTED_EXCEPTION   EQU 2
EXCEPTION_PDATA_COLLIDED_UNWIND    EQU 3
