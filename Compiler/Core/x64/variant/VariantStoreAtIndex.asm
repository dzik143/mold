...
;
; rcx = box   (Variant_t) (IN)
; rdx = index (primitive) (IN)
; r8  = rv    (int64)     (IN)
;
;###############################################################################

__temp_MOLD_VariantStoreAtIndex_int32:
    lea     rax, [__TempInteger]
    movsxd  r8, r8d
    jmp     __MOLD_VariantStoreAtIndex_primitiveDone

__temp_MOLD_VariantStoreAtIndex_bool32:
    lea     rax, [__TempBoolean]
    jmp     __MOLD_VariantStoreAtIndex_primitiveDone

__temp_MOLD_VariantStoreAtIndex_float64:
...
__temp_MOLD_VariantStoreAtIndex_string:

proc __temp_MOLD_VariantStoreAtIndex_variant
