...
start:
    ...
    pop   rbx                     ;
    push  rbx                     ; rbx = retAddr (to parent module)
...
.scanNextProc:
    ...
    ; Map literals base to rdi to avoid usage
    ...
    __imp_name_Kernel32     EQU rdi + __literals.Kernel32     - __literals
    __imp_name_LoadLibraryA EQU rdi + __literals.LoadLibraryA - __literals
    __imp_name_User32       EQU rdi + __literals.User32       - __literals
    __imp_name_MessageBoxA  EQU rdi + __literals.MessageBoxA  - __literals

    messageText    EQU rdi + __literals.messageText    - __literals
    messageCaption EQU rdi + __literals.messageCaption - __literals
